...
psnr1=skimage.metrics.peak_signal_noise_ratio((HR_image*255).astype(np.uint8),(np.squeeze(output_.numpy())*255).astype(np.uint8))#psnr of SR and HR#
print('psnr of SR=',psnr1)

psnr2=skimage.metrics.peak_signal_noise_ratio((LR_image*255).astype(np.uint8),(HR_image*255).astype(np.uint8))#psnr of LR and HR#
print('psnr of LR=',psnr2)
